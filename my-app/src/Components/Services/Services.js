...
const Services = () => {
    ...
    return (
        <div>
            <h2 className="text-center my-5 " style={{ fontFamily: 'Besley', color: "#303f9f" }}>TYPE OF <span style={{ fontFamily: 'Besley', color: "#007bff" }}>DOCTORS</span></h2>
                    ...
                    fakedata.map(v =>
                        ...
                        <div className="col-4 rounded" style={{ fontFamily: 'Besley' }}>
                            ...
                            <div className="ps-5 ms-2">
                                ...
                                <button className="btn btn-danger rounded-pill">Click Me</button>
